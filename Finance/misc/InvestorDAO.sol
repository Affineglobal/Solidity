/*
 ...
 Dai/cDai
	  ...
	  Investor who wraps her ether and delegates it to the smart contract to move her funds, based on her
	own rates or rates provided by an approved oracle.
	    
	    Manager who thinks he knows the best ratios and therefore submits a struct with the appropriate figures 
	    (can update them as he pleases)
	    
	    Agent: Makes a small fee by triggering the smart contract when a price event occurs
